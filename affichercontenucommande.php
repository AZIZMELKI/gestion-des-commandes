    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/123.png" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="assets/images/123.png" alt="logo"/></a>
        </div>
        <tr></tr>
        <ul class="nav">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <span class="profile-name">MANETTE Store</span>
                </a>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Gestion des commandes <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
              </h3>
              <div class="d-flex">
         ...
         <table class="table table-bordered table-striped mb-none"  id="myTable2" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
              <thead>
              <h4 style="color:rgb(124, 160, 196)">la commande numéro:<?php echo $idrecup; ?></h4><br>
                <tr>
                          <th style="color:rgb(124, 160, 196)">ID produit</th>
                           <th style="color:rgb(124, 160, 196)">Nom</th>
                           <th style="color:rgb(124, 160, 196)">Quantite</th>
                           <th style="color:rgb(124, 160, 196)">Prix</th>
                           <th style="color:rgb(124, 160, 196)">Total</th>
                           <th style="color:rgb(124, 160, 196)">image</th>
                        </tr>
                            <?PHP
                        ...
                        <form method="POST" action="affichercontenucommande.php">
                              <button class="btn btn-outline-secondary btn-rounded btn-icon" name="supprimer" ><img src="images/mmm.png"></button>
