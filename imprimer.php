...
<page backtop="5mm">
	 ...
	 <h1 style="color:rgb(124, 160, 196)"> Toutes les commandes </h1>
	 <br><br><br>
		<table style="width:400%;border: 2px dashed " >
		<tr>

														  <th style="color:rgb(124, 160, 196)" scope="col">idcommande</th>
													      <th style="color:rgb(124, 160, 196)" scope="col">date</th>
													      <th  style="color:rgb(124, 160, 196)" scope="col">montantCommande</th>
													      <th style="color:rgb(124, 160, 196)" scope="col">etatcom</th>
													      <th style="color:rgb(124, 160, 196)" scope="col">lieu</th>
