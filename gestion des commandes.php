    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          ...
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.php"><img src="assets/images/123.png" alt="logo"/></a>
        </div>
        <tr></tr>
        <ul class="nav">
...
-->
        ...
        <span class="menu-title" style="color:rgb(124, 160, 196)">Historique des commandes</span>
        </a>
        ...
        <span class="menu-title" style="color:rgb(124, 160, 196)">statistiques des commandes</span>
        </a>
       ...
       <a class="nav-link" href="imprimer.php">
        ...
        <span class="menu-title" style="color:rgb(124, 160, 196)">imprimer les commandes</span>
        </a>
    ...
    -->
                      ...
                      <td>
                        ...
                        <form method="POST" action="validercommande.php">
                              <button class="btn btn-outline-secondary btn-rounded btn-icon" name="valider" onsubmit="test()"; ><img src="images/valider.png"></button>
                              <input type="hidden" value="<?PHP echo $row['idCommande']; ?>" name="idCommande">
                        </form      
